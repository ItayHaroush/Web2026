                                ...
                                >
                                    ...
                                    <div className={`p-8 pb-6 border-b border-gray-50 transition-colors ${order.status === 'ready' ? 'bg-amber-50/50' :
                                        ...
                                        <div className="flex justify-between items-start mb-4">
                                            ...
                                            <div className={`px-4 py-1.5 rounded-2xl text-[10px] font-black uppercase tracking-wider shadow-sm flex items-center gap-1.5 ${
                                                ...
                                                {order.payment_status === 'paid'
                                                    ...
                                                    : order.payment_status === 'failed' ? 'נכשל' : ''}
                                            </div>
                                            )}
                                        </div>
